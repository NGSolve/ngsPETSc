...
def test_firedrake_Adaptivity_netgen():
    ...
    if __name__ == "__main__":
        test_firedrake_Adaptivity_netgen()
        test_firedrake_integral_2D_netgen()
        test_firedrake_integral_3D_netgen()
        test_firedrake_integral_ball_netgen()
        test_firedrake_integral_sphere_high_order_netgen()
        test_firedrake_Poisson_netgen()
